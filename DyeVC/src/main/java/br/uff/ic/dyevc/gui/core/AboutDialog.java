...
public class AboutDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        String textAbout = new StringBuilder("<html><body><p align='center'>").append("<img src='").append(
                               AboutDialog.class.getResource("/br/uff/ic/dyevc/images/splash.png")).append(
                               "'/></p></body></html>").toString();
