 ...
 * 
 */
public class EdgeLabelDemoDyeVC1 extends JApplet {
	...
	public EdgeLabelDemoDyeVC1() {
        
        // create a simple graph for the demo
        graph = new SparseMultigraph<Integer,Number>();
        Integer[] v = createVertices(5);
        createEdges(v);
    ...
    void createEdges(Integer[] v) {
        graph.addEdge(new Double(Math.random()), v[4], v[0], EdgeType.DIRECTED);
        ...
        graph.addEdge(new Double(Math.random()), v[3], v[2], EdgeType.DIRECTED);
        graph.addEdge(new Double(Math.random()), v[2], v[3], EdgeType.DIRECTED);
        graph.addEdge(new Double(Math.random()), v[1], v[3], EdgeType.DIRECTED);
        graph.addEdge(new Double(Math.random()), v[3], v[1], EdgeType.DIRECTED);
    }
    ...
    public static void main(String[] args) {
        ...
        content.add(new EdgeLabelDemoDyeVC1());
        frame.pack();
