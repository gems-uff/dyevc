...
/**
 * CommitHistoryPane is a Container for the Graph's VisualizationViewer
 * and includes custom horizontal and vertical scrollbars.
 * CommitHistoryPane listens for changes in the scale and
...
public class CommitHistoryPane extends JPanel {
    ...
    /**
     * Create an instance of the CommitHistoryPane to contain the
     * VisualizationViewer
     * @param vv
     */
    public CommitHistoryPane(VisualizationViewer vv) {
        super(new BorderLayout());
        this.vv = vv;
        addComponentListener(new CommitHistoryPane.ResizeListener());        
        ...
        verticalScrollBar.addAdjustmentListener(new CommitHistoryPane.VerticalAdjustmentListenerImpl());
        horizontalScrollBar.addAdjustmentListener(new CommitHistoryPane.HorizontalAdjustmentListenerImpl());
